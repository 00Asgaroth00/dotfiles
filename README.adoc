...
* Nix garbage collection should be periodically run, look into setting up a systemd timer for this, NixOS has gc options in its configuration manager but the nix app with home manager does not.
